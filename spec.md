...
Initial scaffold landed 2026-05-28. Infrastructure + all 487 components present. Pending: `pnpm install` + `vitest run` end-to-end verification.
...
- [x] Generate the 487-component scaffold from templates.
