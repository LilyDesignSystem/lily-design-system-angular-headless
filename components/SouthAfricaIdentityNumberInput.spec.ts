...
describe("SouthAfricaIdentityNumberInput", () => {
  test("renders the input root with the base class", () => {
    const fixture = TestBed.createComponent(SouthAfricaIdentityNumberInput);
    fixture.detectChanges();
    const el = fixture.nativeElement.querySelector("input.south-africa-identity-number-input");
