...
/**
 * MentionsInput — a text input with at-mention autocomplete suggestions
 *
 * Headless Angular component. Renders the semantic HTML root with the
 * kebab-case class hook `mentions-input` and the consumer-provided `className`.
 * Ships zero CSS; the consumer styles via the class hook.
 */
@Component({
  selector: "lily-mentions-input",
  standalone: true,
  template: `<input
