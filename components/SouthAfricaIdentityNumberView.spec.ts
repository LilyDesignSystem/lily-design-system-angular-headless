...
describe("SouthAfricaIdentityNumberView", () => {
  test("renders the span root with the base class", () => {
    const fixture = TestBed.createComponent(SouthAfricaIdentityNumberView);
    fixture.detectChanges();
    const el = fixture.nativeElement.querySelector("span.south-africa-identity-number-view");
