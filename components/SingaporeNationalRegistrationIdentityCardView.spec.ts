...
describe("SingaporeNationalRegistrationIdentityCardView", () => {
  test("renders the span root with the base class", () => {
    const fixture = TestBed.createComponent(SingaporeNationalRegistrationIdentityCardView);
    fixture.detectChanges();
    const el = fixture.nativeElement.querySelector("span.singapore-national-registration-identity-card-view");
