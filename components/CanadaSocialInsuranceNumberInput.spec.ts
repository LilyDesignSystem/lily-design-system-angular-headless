...
describe("CanadaSocialInsuranceNumberInput", () => {
  test("renders the input root with the base class", () => {
    const fixture = TestBed.createComponent(CanadaSocialInsuranceNumberInput);
    fixture.detectChanges();
    const el = fixture.nativeElement.querySelector("input.canada-social-insurance-number-input");
